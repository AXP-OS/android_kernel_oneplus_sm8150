...
KBUILD_CFLAGS += -DCONFIG_OPLUS_USER_BUILD
else
KBUILD_CFLAGS += -DCONFIG_OPLUS_DEBUG_BUILD
endif
...
#endif
$(warning TARGET_MEMLEAK_DETECT_TEST is $(TARGET_MEMLEAK_DETECT_TEST))
$(warning OPLUS_MEMLEAK_DETECT is $(OPLUS_MEMLEAK_DETECT))
